...
class Task():
    ...
    def get_reward(self):
        ...
        """ É válido ressaltar que o agente pode colidir com o chão (coord Z = 0)
        Se o mesmo for menor que o tempo total de cada episódio runtime (padrão de 5 segundos) então é por que uma colisão ocorreu"""
